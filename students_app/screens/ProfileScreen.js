...
// ✅ Cambridge fon rasmi (yo‘lni moslang agar kerak bo‘lsa)
...
export default function ProfileScreen() {
  ...
  return (
    // ✅ BACKGROUND IMAGE bilan o‘raladi
    <ImageBackground source={Cambridge_logo} style={{ flex: 1 }} imageStyle={styles.bgImage}>
